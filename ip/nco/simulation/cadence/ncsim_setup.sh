...
# ACDS 17.1 590 linux 2023.03.27.22:42:13
...
TOP_LEVEL_NAME="nco"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/tokiv5/intelFPGA_lite/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/cadence/sid_2c_1p.v"        -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/cadence/asj_gar.v"          -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/cadence/segment_arr_tdl.v"  -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/cadence/segment_sel.v"      -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/cadence/asj_xnqg.v"         -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
